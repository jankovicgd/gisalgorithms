...
def pip_wn(pgon, point):
    """
    Determines whether a point is in a polygon using the winding number algorithm
    using trigonometric functions. Code adopted from the C program in Graphics Gems IV
    (Haines, 1994).
    Input
        pgon: a list of points as the vertices for a polygon
        point: the point
    Output
    Returns a boolean value of True or False and the number of times the half-line
...
def pip_wn1(pgon, point):
    """
    Determines whether a point is in a polygon using the winding number algorithm
    without trigonometric functions. Code adopted from the C program in Graphics Gems IV
    (Haines, 1994).
    Input
        pgon: a list of points as the vertices for a polygon
        point: the point
